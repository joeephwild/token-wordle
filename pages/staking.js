...
export default function Staking() {
  ...
  const { callStakeToken,  userStake} = useGameContext()
      ...
      <div className="h-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 border-2 border-gray-100 w-[90%] px-10 py-5 mx-20 my-10  rounded-lg  lato">
        ...
        <div className="flex gap-20 justify-between ">
          <div className="w-1/2">
            ...
            <button onClick={() => callStakeToken(stake)} className="p-5 text-center text-white py-5 w-1/3 bg-black cursor-pointer">
              <h1>Stake</h1>
            </button>
          </div>
