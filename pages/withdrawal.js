    ...
    return(
        ...
        <form action="" className="w-1/2 mx-auto mb-12">
            <div className="mt-5">
                ...
                <input type="text" className="w-full py-5 px-3 text-lg font-bold rounded-lg bg-white bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 border-2 border-blue-400" />
                <p className="text-slate-600 text-sm">You will have <span></span> TLC remaining</p>
            </div>
            <div className="mt-3">
